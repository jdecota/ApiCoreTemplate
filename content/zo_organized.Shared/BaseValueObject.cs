...
namespace zo_organized.Shared
{
    public abstract class BaseValueObject : IEquatable<BaseValueObject>
    {
        ...
        public List<PropertyInfo> GetDifferences(BaseValueObject obj1, BaseValueObject obj2)
        {
            if (obj1 is null)
            ...
            {
                if (obj2.GetType().GetProperties().Any(a => a.Name.Equals(property.Name, StringComparison.Ordinal)))
                {
